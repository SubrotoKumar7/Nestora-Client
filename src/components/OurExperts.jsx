            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                {
                    ...
                    <div
                        key={i}
                        className="bg-base-100 rounded-xl shadow-md hover:shadow-xl transition duration-300 text-center p-6"
                    >
                        <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-primary shadow-sm">
                        <img
                            src={agent.image}
                            alt={agent.name}
                        ...
                        <p className="text-primary text-sm mt-2">{agent.email}</p>

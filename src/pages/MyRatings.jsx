...
const MyRatings = () => {
  ...
  useEffect(() => {
    fetch(`https://nestora-server-api.vercel.app/reviews?email=${user.email}`)
      .then((res) => res.json())
      .then((data) => {
        setReview(data);
      });
  ...
  return (
    <div className="w-11/12 mx-auto sec-gap">
      <div className="text-center space-y-2 mb-10">
        ...
        <p>
          Browse through reviews from verified users and get a closer look at
          the experiences shared by others on your property listings.
        </p>
      </div>

    ...
    return (
        <div className='sec-gap  bg-gray-100'>
            <div className='text-center space-y-2 mb-10'>
                ...
                <p>Edit the information for your property listing to keep it up-to-date and accurate.</p>
            </div>
            <div className="w-11/12 mx-auto min-h-screen flex justify-center items-start py-12">
                <div className="bg-white p-10 rounded-lg shadow-2xl w-full max-w-3xl">
                    ...
                    {/* Agent Info */}
                    <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Agent Information</h3>

                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Agent Image URL</label>
                        <input
                        type="text"
                        name="agentImage"

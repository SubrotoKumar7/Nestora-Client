    ...
    return (
        <div className='h-screen grid place-items-center bg-base-300'>
                <div className="card-body w-fit md:w-[400px] bg-base-100 py-4 px-7 shadow-2xl rounded">
                    <h1 className='text-3xl text-center mb-4 font-semibold'>Welcome Back!</h1>
                    ...
                    <div>
                        ...
                        <p className='my-3 font-medium text-center'>Don't have an account? <Link className='font-semibold text-primary' to='/register'>Register</Link></p>
                        <p className='text-center font-medium'>Or With</p>
                        <div className='flex justify-center my-2'>
                            {/* Google */}
                            <button onClick={handleGoogle} className="btn w-full border-[#e5e5e5]">
